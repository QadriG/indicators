...
SLEEP_INTERVAL = 3600  # Check every 1 hour (in seconds)
CONFIDENCE_THRESHOLD = 0.70  # Only log if confidence >= 70%
    ...
    while True:
        try:
            ...
            if signals:
                ...
                print(f"✅ {len(signals)} HIGH-CONFIDENCE signals saved to {OUTPUT_CSV}")
                print("-" * 60)
